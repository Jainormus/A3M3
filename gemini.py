...
def gemini(key: str, page_content: str) -> str:
    ...
    query = (f"Summarize this text in a three sentences, if the page is lacking)"
            f"in information or you do not see any text after the &*^% respond with 'This page is lacking enough information for a summary' and nothing else &*^% {page_content}")
